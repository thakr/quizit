    ...
    >
      <div className="border-zinc-800 border-[1.5px] rounded-lg p-2 flex items-center flex-col bg-black bg-opacity-10 shadow-lg">
        ...
        <div className="pt-5 pb-5 px-10">
          <button
            className="flex items-center bg-white rounded-lg p-3 text-zinc-700 font-bold px-10 text-left"
            onClick={() => logIn("google", params.get("redirect"))}
          >
            <svg
        ...
        <p className="pb-10 pt-5 text-zinc-300">
