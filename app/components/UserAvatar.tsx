...
export default function UserAvatar({session} : {session: Session}) {
  return (
    <>
    {session.user ? (<Avatar.Root className="bg-zinc-800 inline-flex h-[35px] w-[35px] select-none items-center justify-center overflow-hidden rounded-full align-middle shadow-lg">
        <Avatar.Image
